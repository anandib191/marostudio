...
const Step1 = () => (
    <div className="p-4 flex flex-col items-center justify-center gap-4 animate-fade-in">
        <div className="relative w-full aspect-square rounded-xl overflow-hidden border-2 border-dashed border-indigo-400/30 p-4 bg-black/40">
            <div className="absolute top-3 left-3 flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500 text-white font-bold text-[10px] uppercase tracking-widest z-10">
...
const Step3 = () => (
    <div className="relative p-4 flex flex-col items-center justify-center gap-8 animate-fade-in h-[404px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
            <div className="w-20 h-20 rounded-full bg-indigo-600 flex items-center justify-center shadow-2xl shadow-indigo-500/30 animate-pulse">
                <LightningIcon className="w-8 h-8 text-white" />
            </div>
            <p className="font-bold text-[10px] tracking-[0.5em] text-indigo-400 uppercase">Generating Views</p>
     ...
     <div className="animate-fade-in">
        <div className="p-4">
            <div className="relative rounded-xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                />
                <div className="absolute top-3 left-3 flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500 text-white font-bold text-[10px] uppercase tracking-widest">
        ...
        <div className="px-6 pb-6 text-center">
            ...
            <p className="text-[10px] text-neutral-500 uppercase tracking-widest mt-2">Ready for deployment.</p>
        </div>
    </div>
);
...
export const DemoCard: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-sm mx-auto bg-neutral-900/60 backdrop-blur-3xl rounded-[32px] border border-white/5 shadow-2xl overflow-hidden animate-float-card">
            <div className="px-8 py-5 flex justify-between items-center border-b border-white/5 bg-white/5">
                ...
                <span className="text-indigo-400 text-[10px] font-bold uppercase tracking-widest">State 0{step}</span>
            </div>
