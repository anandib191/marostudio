    ...
    return (
        <div className="w-full py-4 md:py-6 bg-black">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-6 lg:gap-4 items-stretch perspective-container">
                        {plans.map((plan, index) => {
                            ...
                            return (
                                <div
                                    key={`${plan.name}-${index}`}
                                    className={`relative rounded-2xl p-6 sm:p-8 text-center flex flex-col h-full transition-all duration-500 ease-out hover:shadow-xl ${plan.isPopular
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        ...
                                        <div className="mt-auto pt-8">
                                            <button
                                                ...
                                                disabled={isDisabled}
                                                className={`w-full py-3 px-6 text-xl font-semibold rounded-lg transition-all duration-300 transform ${isDisabled
                ...
                {/* View Purchase History link for authenticated users */}
                {isAuthenticated && (
                    <div className="flex justify-center mt-10">
                        ...
                        >
                            <svg className="w-4 h-4 group-hover:text-gold-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
