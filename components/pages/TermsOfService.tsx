        ...
        <div className="bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-white/10 p-6 md:p-8 lg:p-10 space-y-8 text-neutral-300">
          ...
          <section>
            ...
            <p className="text-neutral-300 leading-relaxed">
              By accessing and using NextGen Photo Studio ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-neutral-300 leading-relaxed">
              NextGen Photo Studio provides AI-powered photography generation services, including but not limited to professional photoshoot generation, marketing poster creation, and related visual content generation tools. The Service uses artificial intelligence to generate images based on user-provided inputs and preferences.
            </p>
          </section>
