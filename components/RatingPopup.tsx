                            ...
                            <div className="flex justify-center gap-1.5 sm:gap-2 mb-2">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    <button
                                        ...
                                        className="group p-1 transition-transform duration-200 hover:scale-110 sm:hover:scale-125 focus:outline-none"
                                        style={{ color: star <= activeStar ? '#e6b71e' : isLight ? '#d1d5db' : '#404040' }}
                                    >
                                        <svg className="w-6 h-6 sm:w-8 sm:h-8 transition-all duration-200" viewBox="0 0 24 24" fill={star <= activeStar ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={star <= activeStar ? 0 : 1.5}>
