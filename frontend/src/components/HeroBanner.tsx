  ...
  return (
    <section className="hero-banner relative bg-black min-h-[calc(80vh)] flex items-center pt-4 pb-8 px-4 sm:px-6 lg:px-8 w-full -mx-4 sm:-mx-5 md:-mx-6 lg:-mx-8">
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{
          background: `
            radial-gradient(circle at 30% 30%, rgba(230, 183, 30, 0.06) 0%, transparent 50%),
            radial-gradient(circle at 70% 70%, rgba(174, 130, 13, 0.04) 0%, transparent 50%)
          `
        }}
      />
        ...
        <div className="hero-content-wrapper grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="hero-text w-full max-w-full text-left lg:text-left text-center lg:text-left flex flex-col justify-center animate-slide-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-4 text-white tracking-tight">
              One Click <span className="hero-gradient-text bg-gradient-to-r from-gold-300 via-gold-400 to-gold-600 bg-clip-text text-transparent drop-shadow-lg">Professional Photoshoot</span><br />
              Without Studio
            </h1>
            <h2 className="hero-desc text-base sm:text-lg md:text-xl font-normal leading-relaxed text-white mb-8 max-w-full">
            ...
            <div className="tagline-button-alignment flex flex-wrap gap-3 justify-start lg:justify-start justify-center mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <div className="tagline inline-flex items-center gap-2 px-4 py-2.5 bg-gold-500/15 border border-gold-500/40 rounded-lg text-sm font-medium text-white hover:bg-gold-500/25 hover:border-gold-400/50 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="18" height="18" className="text-gold-400 flex-shrink-0" fill="currentColor">
            ...
            <div className="hero-button-alignment flex gap-4 justify-start lg:justify-start justify-center flex-wrap animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <button
                ...
                className="button-ui inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-lg font-semibold text-lg cursor-pointer transition-all"
              >
